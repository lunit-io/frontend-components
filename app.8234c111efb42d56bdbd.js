...
`},function(t,e,o){"use strict";function n({element:t,getCurrentViewport:e,onMove:o,onEnd:n,contentWindow:r}){let i,s,a,c;function l(o){if(0!==o.button)return;o.stopPropagation(),o.stopImmediatePropagation(),o.preventDefault();const n=e();n&&(t.removeEventListener("mousedown",this.onAdjustStart),i=o.pageX,s=o.pageY,a=n.voi.windowCenter,c=n.voi.windowWidth,r.addEventListener("mousemove",d),r.addEventListener("mouseup",u),t.addEventListener("mouseleave",u))}function d(t){t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault();const e=t.pageX-i,n=t.pageY-s;o({windowWidth:Math.max(c+e,1),windowCenter:Math.max(a+n,1)})}function u(e){0===e.button&&(e.stopPropagation(),e.stopImmediatePropagation(),e.preventDefault(),r.removeEventListener("mousemove",d),r.removeEventListener("mouseup",u),t.removeEventListener("mouseleave",u),t.addEventListener("mousedown",l),n())}return t.addEventListener("mousedown",l),()=>{t.removeEventListener("mousedown",l),r.removeEventListener("mousemove",d),r.removeEventListener("mouseup",u),t.removeEventListener("mouseleave",u)}}o.d(e,"a",(function(){return n}))},function(t,e,o){"use strict";function n({element:t,getCurrentViewport:e,onMove:o,onEnd:n,contentWindow:r}){let i,s,a,c;function l(){t.addEventListener("mousedown",u),t.addEventListener("touchstart",h)}function d(){t.removeEventListener("mousedown",u),t.removeEventListener("touchstart",h)}function u(o){if(0!==o.button)return;o.stopPropagation(),o.stopImmediatePropagation(),o.preventDefault();const n=e();n&&(d(),i=o.pageX,s=o.pageY,a=n.translation.x,c=n.translation.y,r.addEventListener("mousemove",m),r.addEventListener("mouseup",f),t.addEventListener("mouseleave",f))}function h(t){if(1!==t.targetTouches.length)return;t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault();const o=e();o&&(d(),i=t.touches[0].pageX,s=t.touches[0].pageY,a=o.translation.x,c=o.translation.y,r.addEventListener("touchmove",p),r.addEventListener("touchend",v),r.addEventListener("touchcancel",v))}function p(t){if(1!==t.targetTouches.length||1!==t.changedTouches.length)return;t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault();const n=e();if(!n)return;const r=(t.touches[0].pageX-i)/n.scale,l=(t.touches[0].pageY-s)/n.scale;o({x:a+r,y:c+l})}function v(t){t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault(),r.removeEventListener("touchmove",p),r.removeEventListener("touchend",v),r.removeEventListener("touchcancel",v),l(),n()}function m(t){t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault();const n=e();if(!n)return;const r=(t.pageX-i)/n.scale,l=(t.pageY-s)/n.scale;o({x:a+r,y:c+l})}function f(e){0===e.button&&(e.stopPropagation(),e.stopImmediatePropagation(),e.preventDefault(),r.removeEventListener("mousemove",m),r.removeEventListener("mouseup",f),t.removeEventListener("mouseleave",f),l(),n())}return l(),()=>{t.removeEventListener("mousedown",u),r.removeEventListener("mousemove",m),r.removeEventListener("mouseup",f),t.removeEventListener("mouseleave",f),t.removeEventListener("touchstart",h),r.removeEventListener("touchmove",p),r.removeEventListener("touchend",v),r.removeEventListener("touchcancel",v)}}o.d(e,"a",(function(){return n}))},function(t,e,o){"use strict";function n({element:t,getMinMaxScale:e,getCurrentViewport:o,onZoom:n,contentWindow:r}){function i(i){i.preventDefault(),i.stopPropagation(),i.stopImmediatePropagation();const[s,a]=e(),c=o();if(!c)return;const l=i.deltaY>0?1:-1,d=Math.max(s,Math.min(a,c.scale-.03*l));if(c.scale===d)return;const{top:u,left:h,width:p,height:v}=t.getBoundingClientRect(),m=i.pageX-r.scrollX-(h+p/2),f=i.pageY-r.scrollY-(u+v/2),g=(1-d/c.scale)*m,b=(1-d/c.scale)*f;n({translation:{x:c.translation.x+g/d,y:c.translation.y+b/d},scale:d})}return t.addEventListener("wheel",i),()=>{t.removeEventListener("wheel",i)}}o.d(e,"a",(function(){return n}))},function(t,e,o){"use strict";o.d(e,"a",(function(){return i}));var n=o(136),r=o.n(n);function i(t,e){return t.find(t=>r()(e,t.polygon))||null}},function(t,e,o){"use strict";o.d(e,"a",(function(){return i}));var n=o(2);const r=n.e`
  to {
    stroke-dashoffset: 0;
  }
`,i=n.c`
...
`,n.d.div`
  ...
  right: 5px;
  bottom: 5px;
`},function(t,e,o){"use strict";o(151);var n=o(0),r=o(2);o(57);Object(n.createContext)({inProgress:!1,setProgress:()=>{},unsetProgress:()=>{}});r.d.div`
  position: absolute;
  top: 0;
  left: 0;
  display: flex;
...
`},function(t,e,o){"use strict";var n=o(0),r=o.n(n),i=o(2);class s extends n.Component{constructor(...t){super(...t),this.svgRef=Object(n.createRef)()}render(){const{cornerstoneRenderData:t,contours:e,focusedContour:o}=this.props;return r.a.createElement("svg",{ref:this.svgRef,className:this.props.className,style:this.props.style,width:this.props.width,height:this.props.height},e.length>0&&t&&t.element&&e.map(e=>{const{cx:i,cy:s,r:a}=function(t,e){const{x:o,y:n}=cornerstone.pixelToCanvas(t,{x:e[0][0],y:e[0][1]}),{x:r,y:i}=cornerstone.pixelToCanvas(t,{x:e[1][0],y:e[1][1]});return{cx:o,cy:n,r:Math.sqrt(Math.pow(Math.abs(r-o),2)+Math.pow(Math.abs(i-n),2))}}(t.element,e.polygon),c=e===o,l=e.dataAttrs||{};return r.a.createElement(n.Fragment,{key:"circle"+e.id},!0===this.props.border&&r.a.createElement("circle",Object.assign({},l,{"data-border":"border","data-id":e.id,"data-focused":c||void 0,cx:i,cy:s,r:a})),r.a.createElement("circle",Object.assign({},l,{"data-id":e.id,"data-focused":c||void 0,cx:i,cy:s,r:a})),!0===this.props.border&&r.a.createElement("text",Object.assign({},l,{"data-border":"border","data-id":e.id,"data-focused":c||void 0,fontSize:14*Math.max(1,t.viewport.scale),x:i,y:s}),e.label?"function"===typeof e.label?e.label(e):e.label:e.id),r.a.createElement("text",Object.assign({},l,{"data-id":e.id,"data-focused":c||void 0,fontSize:14*Math.max(1,t.viewport.scale),x:i,y:s}),e.label?"function"===typeof e.label?e.label(e):e.label:e.id))}))}}s.defaultProps={border:!0};Object(i.d)(s)`
  position: absolute;
  top: 0;
  left: 0;
  pointer-events: none;
...
`},function(t,e,o){"use strict";var n=o(185),r=(o(183),o(154),o(158),o(153),o(156),o(157),o(26),o(0),o(2));Object(r.d)(n.a)`
  position: absolute;
  top: 10px;
  right: 10px;
  width: 200px;
`},,function(t,e,o){"use strict";o(0)},function(t,e,o){"use strict";var n=o(0);o(18);n.Component},function(t,e,o){"use strict";o(60)},function(t,e,o){"use strict";o(61)},function(t,e,o){"use strict";o(62)},function(t,e,o){"use strict";o(0)},function(t,e,o){"use strict";o(0)},function(t,e,o){"use strict";o(0)},function(t,e,o){"use strict";o(0)},function(t,e,o){"use strict";o(0),o(186),o(84)},function(t,e,o){"use strict";var n=o(0);o(58);const r=Object(n.createContext)();r.Consumer},function(t,e,o){"use strict";o(27),o(84);var n=o(31);o(46),o(75);new n.a},function(t,e,o){"use strict"},function(t,e,o){"use strict";o(27)},function(t,e,o){"use strict";o(27)},function(t,e,o){"use strict";o(27),o(84);new(o(31).a)},function(t,e,o){"use strict";o(27)},function(t,e,o){"use strict"},function(t,e,o){"use strict";o(0);var n=o(2),r=o(59);n.b`
  html {
    font-size: 14px;
...
`;n.Component},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(t,e,o){"use strict";o.r(e);var n=o(41),r=o(0),i=o.n(r),s=o(14),a=o(2);const c=a.c`
...
`;a.b`
  ${l}
`;o(218),o(211);var d=o(148);Object(d.a)({palette:{type:"dark"},typography:{fontFamily:"proximanova,noto_sanslight,sans-serif",fontWeightLight:200,fontWeightRegular:400,fontWeightMedium:600,fontWeightBold:700},overrides:{MuiTooltip:{tooltip:{fontSize:13,backgroundColor:"rgba(0, 0, 0, 0.5)"}}}});a.b`
  html {
    font-size: 14px;
    box-sizing: border-box;
  }
  ...
  ${l}
`;var u=o(155),h=o(140),p=o.n(h);const v=i.a.createElement(p.a,null),m="LunitButton-label",f="LunitButton-icon",g="LunitButton-check";function b({label:t,icon:e,check:o=v,className:n="",selected:s,onChange:a,onClick:c,hideCheck:l,style:d={},disabled:h=!1,...p}){const b=Object(r.useCallback)(t=>{"boolean"===typeof s&&"function"===typeof a&&a(!s),"function"===typeof c&&c(t)},[s,a,c]);return i.a.createElement(u.a,Object.assign({},p,{className:n,"aria-selected":!0===s,style:d,onClick:b,disabled:h}),e&&i.a.createElement("span",{className:f},e),t&&i.a.createElement("span",{className:m},t),!0!==l&&!0===s&&i.a.createElement("span",{className:g},o))}Object(a.d)(b).attrs(t=>{if(!t.label||!t.icon)throw new Error("the props label and icon are required to <IconAndLabelButton>");return"left"===t.layout&&console.warn("<IconAndLabelButton> layout prop is only support 'center'"),!1===t.hideCheck&&console.warn("<IconAndLabelButton> hideCheck prop is only support 'true'"),{...t,hideCheck:!0,layout:"center"}})`
  && {
    flex: 1;
    justify-content: center;
...
`;var w=o(141),E=o.n(w);const x="LunitPanel-header",k="LunitPanel-icon",y="LunitPanel-title",M="LunitPanel-content";const I=Object(a.d)(E.a)`
...
`,j=Object(a.d)((function({className:t="",expanded:e,onChange:o,style:n={},title:s,icon:a,children:c,disabled:l}){const d=Object(r.useCallback)(()=>{"boolean"===typeof e&&"function"===typeof o&&o(!e)},[e,o]),u="function"===typeof c?c(!0===e):c,h=function(t,e){const o="function"===typeof t?t(!0===e):t;return o||("boolean"!==typeof e?null:e?i.a.createElement(I,null):i.a.createElement(I,{style:{transform:"rotate(180deg)"}}))}(a,e);return i.a.createElement("div",{className:t,"aria-expanded":!0===e,"aria-disabled":!0===l,style:n},i.a.createElement("div",{className:x},h&&i.a.createElement("span",{className:k,onClick:d},h),i.a.createElement("span",{className:y},"function"===typeof s?s(!0===e):s)),u&&i.a.createElement("div",{className:M},u))}))`
  ${({disabled:t})=>t?a.c`
        opacity: 0.4;
        pointer-events: none;
        user-select: none;
...
`;Object(a.d)((function({sessionId:t,defaultExpanded:e=!0,onChange:o,...n}){const s=Object(r.useMemo)(()=>`__sidebar_panel_${t}__`,[t]),[a,c]=Object(r.useState)(()=>{const t=localStorage.getItem(s);return"string"===typeof t?"open"===t:e}),l=Object(r.useCallback)(t=>{localStorage.setItem(s,t?"open":"close"),c(t),"function"===typeof o&&o(t)},[s,o]);return i.a.createElement(j,Object.assign({},n,{expanded:a,onChange:l}))}))`
...
`;Object(a.d)((function({children:t,className:e=""}){return i.a.createElement("div",{className:e},t)}))`
  position: absolute;
  height: ${25}px;
  display: flex;
  align-items: center;
...
`;Object(a.d)((function({className:t="",children:e,style:o}){return i.a.createElement("div",{className:t,style:o},e)}))`
  ${({direction:t})=>"horizontal"===t?S:C};
`;var T=o(157);Object(a.d)(T.a).attrs({valueLabelDisplay:"on"})`
  && {
...
`,Object(a.d)($).attrs({children:i.a.createElement(_,{style:{color:"#c9434b"}})})`
  ...
  --tooltip-label-color: #ffffff;
`;o(78);r.Component;o(183),o(149);var N=o(154);Object(a.d)(N.a)`
  && {
    .MuiSwitch-track {
      opacity: 1;
...
`;var U=o(219);o(213),o(214),o(215),o(216);Object(a.d)(U.a)`
  && {
    .MuiDialog-paper {
      ${X};
...
`;var B=o(182);o(147),o(146),o(145);a.c`
  display: flex;
...
`;var H=o(217);const Z=Object(a.d)(H.a)`
  && {
    border-radius: 0;
...
`,K=(Object(a.d)((function({source:t,children:e,...o}){return i.a.createElement("div",o,i.a.createElement("video",{autoPlay:!0,loop:!0,muted:!0},t),e)}))`
  position: relative;
  overflow: hidden;
...
`);function G(){const t=Object(r.useMemo)(()=>new n.CornerstoneSingleImage("wadouri:https://fixtures.front.lunit.io/dcm-files/series/CT000010.dcm",{unload:n.unloadImage}),[]);return i.a.createElement("div",null,i.a.createElement(K,null),i.a.createElement(n.InsightViewer,{width:700,height:600,invert:!1,flip:!1,pan:!0,adjust:!1,zoom:!0,resetTime:Date.now(),image:t,updateCornerstoneRenderData:()=>{}}))}Object(n.installWADOImageLoader)(),Object(s.render)(i.a.createElement(G,null),document.querySelector("#app"))}]));
//# sourceMappingURL=app.8234c111efb42d56bdbd.js.map